...
def create_tables():
    ...
    try:
        ...
        CREATE TABLE IF NOT EXISTS social_media_data (
            ...
            topic VARCHAR(50) DEFAULT 'education',
        ...
        indexes = [
            ...
            "CREATE INDEX IF NOT EXISTS idx_topic ON social_media_data(topic);",
            "CREATE INDEX IF NOT EXISTS idx_topic_platform ON social_media_data(topic, platform);"
        ]
