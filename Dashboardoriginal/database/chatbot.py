...
class DashboardChatbot:
    ...
    def get_data_context(self, platform: str = 'All Platforms', topic: str = 'All Topics') -> str:
        ...
        try:
            ...
            if platform == 'All Platforms':
                df = self.db_manager.get_platform_data(platform=None, topic=topic)
            else:
                df = self.db_manager.get_platform_data(platform, topic=topic)
    ...
    def generate_system_prompt(self, platform: str = 'All Platforms', topic: str = 'All Topics') -> str:
        """Generate system prompt with current dashboard context"""
        data_context = self.get_data_context(platform, topic)
    ...
    def chat_with_ai(self, user_message: str, platform: str = 'All Platforms', topic: str = 'All Topics', chat_history: List[Dict] = None) -> str:
        ...
        try:
            ...
            # Prepare messages
            system_prompt = self.generate_system_prompt(platform, topic) + additional_context
            messages = [
    ...
    def get_suggested_questions(self, platform: str = 'All Platforms', topic: str = 'All Topics') -> List[str]:
        ...
        if topic == 'Education':
            base_questions.extend([
                ...
                "📚 What are the main educational concerns?",
                "🏫 How do people discuss UAE education?",
            ])
        elif topic == 'Economy':
            base_questions.extend([
                "💼 What are the main economic trends?",
                "📈 How do people discuss UAE economy?",
                "💰 What economic issues are highlighted?",
                "🏢 What business topics are trending?",
            ])
        else:
            base_questions.extend([
                "🎓 Summarize posts about education or school",
...
def render_chatbot_interface(platform: str = 'All Platforms', topic: str = 'All Topics'):
    ...
    if not st.session_state.chat_history:
        ...
        suggestions = st.session_state.chatbot.get_suggested_questions(platform, topic)
