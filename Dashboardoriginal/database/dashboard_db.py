...
class DatabaseManager:
    ...
    def execute_query(self, query, params=None):
        ...
        try:
            ...
            # Handle empty parameter dictionaries
    ...
    def get_platform_stats(self, topic=None):
        ...
        query += " GROUP BY platform ORDER BY total_posts DESC"
        
        return self.execute_query(query, params)
    
    def get_recent_posts(self, limit=10, platform=None, topic=None):
        """Get recent posts"""
        query = """
        SELECT title, platform, sentiment_predicted, sentiment_confidence, date, url, topic
        FROM social_media_data 
        WHERE 1=1
        """
        params = {}
    ...
    def get_time_series_data(self, platform=None, topic=None, days=30):
...
@st.cache_data
def load_data_from_db(platform='All Platforms', topic='All Topics'):
    """Load data from database with caching"""
    return db_manager.get_platform_data(platform, topic)

def get_sentiment_stats(platform='All Platforms', topic='All Topics'):
    """Get sentiment statistics"""
    return db_manager.get_sentiment_summary(platform, topic)

def get_recent_posts_db(limit=10, platform='All Platforms', topic='All Topics'):
    """Get recent posts from database"""
    return db_manager.get_recent_posts(limit, platform, topic) 